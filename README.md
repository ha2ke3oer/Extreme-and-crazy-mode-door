...
Achievements.Get({
    Title = "DOORS MODE §Extreme & Crazy§",
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Extacutetd") then
    warn("You have Already Loaded")

    return true
end
local Test = Instance.new("Part")
Test.Name = "Extacutetd"
        ...
        while true do wait(120)
            pcall(function()
                ...
                local entity3 = Creator.createEntity({
                    ...
                    Speed = 1830, -- Percentage, 100 = default Rush speed
    ...
    function VhsSanhSpawn()
        while true do 
            ...
            local entity4 = Creator.createEntity({
                CustomName = "白色的", -- Custom name of your entity
